...
| 정면 (Front) | 측면 (Side) | 하단 (Bottom) |
| :---: | :---: | :---: |
| ![Full](images/5.jpg) | ![Wiring](images/6.jpg)  | ![MCU](images/4.jpg) |
| **차량 및 조종기 세트** | **메인 제어 및 배터리** | **구동 모터 및 배선** |

<br>

### 5.2 🕹️ Remote Controller (조종기)

| 전체 샷 (Full Setup) | 내부 배선 (Wiring) | MCU 상세 (MCU) |
| :---: | :---: | :---: |
| ![Front](images/7.jpg) | ![Side](images/2.jpg) | ![Bottom](images/3.jpg) |
| **3구 초음파 센서부** | **조이스틱 연결부** | **STM32F411 제어부** |

<br>

### 5.3 🎬 Demonstration (시연 영상)

[![AutoMobility Demo](images/title.jpg)](여기에_유튜브_링크_주소를_넣으세요)
*이미지를 클릭하면 시연 영상(유튜브 등)으로 이동합니다.*


## 6. Troubleshooting (문제 해결 기록)

<details>
<summary> <b>📍 초음파 센서 데이터 유입 노이즈 및 튀는 현상 (Outlier) </b></summary>

🔍  Issue (문제 상황)
자율 주행 모드 주행 중, 전방에 장애물이 없음에도 불구하고 갑자기 차량이 급정거하거나 방향을 급격히 트는 불안정한 거동이 관찰됨.

❓ Analysis (원인 분석)
STM32 디버깅 툴을 통해 실시간 거리 데이터를 모니터링한 결과, 센서의 난반사 및 주변 환경 요인으로 인해 간헐적으로 0cm 또는 **300cm 이상의 비정상적인 값(Outlier)**이 유입됨을 확인.
